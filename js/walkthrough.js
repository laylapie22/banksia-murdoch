  ...
  function drawLocationsOnMap(id) {
    ...
    resizedPositions.forEach( location => { // left and top
      ...
      markerLocationEl.classList.add('marker_flower_anchor')
      ...
      markerLocationEl.addEventListener('click', () => {
        $(markerLocationEl).tooltip('show')
      })
    })
  }
  ...
  document.getElementById('walkthrough_select_flowers').addEventListener('click', function() {    
    ...
    let listener =  function(e) {
      if ( popperInstance && e.target && !popper.contains(e.target) ) {
  ...
  // $('.marker_flower_anchor').on("click",function(e){
  //   alert('lol')
  //   $(e).tooltip('show');
  // });